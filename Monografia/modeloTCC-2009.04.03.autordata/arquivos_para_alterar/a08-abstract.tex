...
São Pedro de Alcântara. The channel used is available in the ``Plano Básico de Distribuição de Canais de Radiodifusão Sonora em Frequência Modulada ''- PBFM 
...
and approval of its use by ``Agência Nacional de Telecomunicações'' (National Agency of Telecommunications), the ANATEL.
